...
export const Pricing = () => {
  ...
  return (
    <section className="py-20 flex flex-col items-center gap-y-12 relative overflow-hidden">
      ...
      <div
        className="absolute bottom-10 right-1/4 w-48 h-48 bg-chart-3/10 rounded-full blur-2xl animate-pulse"
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    <div
                      className={`w-12 h-12 rounded-2xl bg-gradient-to-br from-primary to-chart-2/70 flex items-center justify-center shadow-lg`}
                    >
                  ...
                  >
                    <Link className=" flex gap-2 justify-center items-center" href={"/send-message"}>
