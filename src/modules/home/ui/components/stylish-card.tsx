    ...
    <div className="relative w-96 h-96 perspective-1000">
      ...
      >
        ...
        <div className="absolute inset-0 opacity-30">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-40 h-40 bg-gradient-to-r from-chart-2/30 to-chart-3/30 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '1s' }}></div>
          <div className="absolute top-1/2 right-1/3 w-24 h-24 bg-gradient-to-r from-chart-4/40 to-primary/30 rounded-full blur-xl animate-pulse" style={{ animationDelay: '2s' }}></div>
        </div>
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="relative z-10">
            {/* Main icon container */}
            <div className={`relative w-20 h-20 bg-gradient-to-br from-primary to-chart-1 rounded-2xl shadow-2xl flex items-center justify-center transition-all duration-500 ${
              isHovered ? 'scale-110 rotate-12' : ''
            }`}>
              <Orbit className="w-10 h-10 text-primary-foreground animate-spin" style={{ animationDuration: '3s' }} />
            ...
            <div className={`absolute -bottom-8 -left-8 transition-all duration-700 ${
              isHovered ? 'transform translate-y-2 -rotate-45' : ''
        ...
        <div className={`absolute top-4 right-4 w-16 h-16 bg-primary/20 rounded-full blur-2xl transition-all duration-500 ${
          isHovered ? 'scale-150 bg-primary/30' : ''
        }`}></div>
        <div className={`absolute bottom-4 left-4 w-20 h-20 bg-chart-4/20 rounded-full blur-2xl transition-all duration-500 ${
        ...
        <div className={`absolute inset-0 overflow-hidden rounded-3xl ${isHovered ? '' : 'opacity-0'}`}>
